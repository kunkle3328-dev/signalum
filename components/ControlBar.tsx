    ...
    <div className="fixed bottom-12 left-0 right-0 flex flex-col items-center gap-7 z-[40] pointer-events-none px-6">
      ...
      {status === 'disconnected' && (
        <div className="flex items-center gap-4 animate-fade-in">
           <div className={`pointer-events-auto bg-black/70 backdrop-blur-3xl border border-white/5 rounded-full px-12 py-4 flex items-center gap-5 shadow-2xl shadow-black/80`}>
      ...
      <div className={`pointer-events-auto w-full max-w-xl glass-morphism p-5 rounded-[4rem] shadow-[0_40px_100px_rgba(0,0,0,0.9)] flex items-center justify-between gap-5 relative overflow-hidden group transition-all duration-700`} style={{ borderColor: theme.colors.hexPrimary + '30' }}>
