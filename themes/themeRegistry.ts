...
export const THEME_REGISTRY: Record<ThemeId, Theme> = {
  midnight: {
    ...
    colors: {
      ...
      border: 'border-cyan-500/40', // Increased opacity
      bgPanel: 'bg-[#05050a]',
      hexPrimary: '#00f3ff',
      hexSecondary: '#60eaff',
      neonColor: '#00f3ff'
